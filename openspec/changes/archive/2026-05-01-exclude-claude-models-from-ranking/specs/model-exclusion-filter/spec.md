...
- **WHEN** a model has `slug: "claude-4-sonnet"`, `frontierModel: true`, coding, and agentic scores
...
- **WHEN** a model has `slug: "gpt-5-5"`, `frontierModel: true`, coding, and agentic scores
- **AND** the exclusion blocklist contains prefix `"claude"`
...
- **THEN** the system SHALL include all rankable frontier models in the ranking
