...
import { DeepSweClient } from "./services/deepswe-client.js";
...
export const aiDomain: FastifyPluginAsync = async (fastify) => {
  ...
  const deepSweClient = new DeepSweClient(domainLogger);
  const modelRankingService = new ModelRankingService(
